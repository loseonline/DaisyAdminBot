...
# if version < 10.6, stop bot.
if sys.version_info[0] < 10 or sys.version_info[1] < 6:
    LOGGER.error(
...
if ENV:
    ...
    from DAİSY.config import Development as Config
    TOKEN = Config.TOKEN
...
from DAİSY.modules.helper_funcs.handlers import (CustomCommandHandler,
