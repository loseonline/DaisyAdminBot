...
from DAİSY import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from DAİSY.__main__ import STATS, TOKEN, USER_INFO
import DAİSY.modules.sql.userinfo_sql as sql
from DAİSY.modules.disable import DisableAbleCommandHandler
from DAİSY.modules.sql.global_bans_sql import is_user_gbanned
from DAİSY.modules.sql.afk_sql import is_afk, check_afk_status
from DAİSY.modules.sql.users_sql import get_user_num_chats
from DAİSY.modules.helper_funcs.chat_status import sudo_plus
from DAİSY.modules.helper_funcs.extraction import extract_user
from DAİSY import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "Appraising...", parse_mode=ParseMode.HTML)

    text = (f"╒═══「 Appraisal results: 」\n"
            f"ID: {user.id}\n"
