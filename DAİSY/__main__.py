...
from DAİSY import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK, pbot,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from DAİSY.modules import ALL_MODULES
from DAİSY.modules.helper_funcs.chat_status import is_user_admin
from DAİSY.modules.helper_funcs.misc import paginate_modules
...
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/usermusti/DaisyAdminBot.git)
"""
...
LEGEND_IMG = "https://telegra.ph/file/984c6afc93e315126267f.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
DAİSY is hosted on one of Heroku's Servers and doesn't require any donations as of now but \
You can donate to the original writer of the Base code, Paul
There are two ways of supporting him; [GitHub](github.com/usermusti), or [👨‍💻Developer](https://t.me/loseonline)."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DAİSY.modules." +
                                              module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                        InlineKeyboardButton(
                            text=" ⚡ Developer x ",
                            url="https://t.me/loseonline"),
                         InlineKeyboardButton(
                            text=" ❤️ Bio ",
                             url="https://t.me/losebio")        
                      ],
                      [ 
                        InlineKeyboardButton(
                             text=" ✨ Dear User ",
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1193186807 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "LADY DAIYS is now online!")
        except Unauthorized:
            LOGGER.warning(
